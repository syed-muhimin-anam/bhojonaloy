      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300 mb-4">Served daily from 7 – 11 am.</p>
            <div>
              <div className="flex justify-between mb-2">
                <div>
                  <h3 className="font-semibold">Paratha & Omelette</h3>
                  <p className="text-sm text-gray-400">Crispy paratha with a spiced omelette.</p>
                </div>
              ...
              <div className="flex justify-between mb-2">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Spiced chickpea curry served with fluffy luchi.</p>
                </div>
              ...
              <div className="flex justify-between mb-2">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Mashed potatoes with mustard oil, onion, and rice.</p>
                </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-300 mb-4">Served daily from 12 – 4 pm.</p>
            <div>
              <div className="flex justify-between mb-2">
                <div>
                  <h3 className="font-semibold">Biriyani</h3>
                  <p className="text-sm text-gray-400">Aromatic rice cooked with spices, meat, and potatoes.</p>
                </div>
              ...
              <div className="flex justify-between mb-2">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Dry fish curry cooked with onions and spices.</p>
                </div>
              ...
              <div className="flex justify-between mb-2">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Hilsa fish curry with mustard sauce.</p>
                </div>
              ...
              <div className="flex justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Traditional mutton biriyani cooked with fragrant rice.</p>
                </div>
