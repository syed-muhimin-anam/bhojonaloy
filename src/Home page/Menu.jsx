  ...
  return (
    <div className=" px-10">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center text-purple-700 mb-7">Our Menu</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Breakfast Section */}
          <div>
            <h2 className="text-2xl font-semibold text-purple-500">Breakfast</h2>
          ...
          {/* Lunch Section */}
          <div>
            <h2 className="text-2xl font-semibold text-purple-500">Lunch</h2>
